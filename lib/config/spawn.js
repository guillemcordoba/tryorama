...
exports.spawnLocal = (player, { handleHook } = {}) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const flag = env_1.default.legacy ? '-c' : '--legacy-tryorama-config-path';
        ...
        const newPort = yield (!env_1.default.legacy
...
const getTrueInterfacePortLegacy = (handle, name) => {
    ...
    let portPattern = new RegExp(`\\*\\*\\* Bound interface '${env_1.default.adminInterfaceId}' to port: (\\d+)`);
