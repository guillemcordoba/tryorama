export declare const Config: {
    gen: (instancesFort: import("./types").Fort<({
        id: string;
        agent: {
            id: string;
            name: string;
    ...
    }>) | undefined) => (args: import("./types").ConfigSeedArgs) => Promise<import("./types").RawConductorConfig>;
    ...
    network: (network: "n3h" | "memory" | "websocket" | {
        [x: string]: any;
    }) => ({ configDir }: {
        configDir: any;
    }) => Promise<{
